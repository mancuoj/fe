...
![](https://p6-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/fa9b283ab5ad407a99627de2ae131a5d~tplv-k3u1fbpfcp-zoom-in-crop-mark:3024:0:0:0.awebp?)
...
![](https://p1-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/40eb2b22902344f09b0b9b98bc3e1bbc~tplv-k3u1fbpfcp-zoom-in-crop-mark:3024:0:0:0.awebp?)

[试一下](hhttps://www.typescriptlang.org/play?ts=4.5.0-beta#code/C4TwDgpgBAwghgWwgG3gZwgFQPYGkIBGcB6EAPAMrABOUEAHsBAHYAmaUaNAlswOYA+KAF4oAKCiSoVWgyZsOAAwAkAb14AzCLQBi3alwC+azdqgAlCEcUSpdgPxQ9B4HUYt2UADLYA7toBjOAwyZy4hWzsoqEcVVTDgY1V4JFRgrDxCYlIyS3DDG2jogC4oRQBaNR9-aiCQhIEklJRSHHwiEnTcq2BGwqLSmQBuMTFQSFhEFvS2rM6MPJFJ1NbMjpyAcj4AVzh+AEE2ABFsfg2BEaA)
...
![](https://p1-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/e3948d21be8a4fb68bc3776deacee22f~tplv-k3u1fbpfcp-zoom-in-crop-mark:3024:0:0:0.awebp?)
...
`type TupleToNestedObject<Tuple extends unknown[], Value> =      Tuple extends [infer First, ...infer Rest]       ? {           [Key in First as Key extends keyof any ? Key : never]:                Rest extends unknown[]                   ? TupleToNestedObject<Rest, Value>                   : Value       }       : Value;`
...
![](https://p1-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/88532b7b2d834b4591306f32cda0b45a~tplv-k3u1fbpfcp-zoom-in-crop-mark:3024:0:0:0.awebp?)

如果提取不出元素，那就构造结束了，返回 Value。

这样就实现了根据元组构造索引类型的功能：

![](https://p9-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/24c8dbf5011d4d27952c32ecfb9b337d~tplv-k3u1fbpfcp-zoom-in-crop-mark:3024:0:0:0.awebp?)

当传入 number 时：

![](https://p6-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/6ca07272383c4728a19b48f064381382~tplv-k3u1fbpfcp-zoom-in-crop-mark:3024:0:0:0.awebp?)

当传入 undefined 时：

![](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/20afc50bcef84df1853a60e9f5e10a34~tplv-k3u1fbpfcp-zoom-in-crop-mark:3024:0:0:0.awebp?)
...
`interface Dong {     name: string     age: number     address: string }`
...
`interface Dong2 {     name?: string     age?: number     address: string  }`
...
![](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/bda4effa66cc46338c0bed9ced7c492e~tplv-k3u1fbpfcp-zoom-in-crop-mark:3024:0:0:0.awebp?)

然后把剩下的 Key 摘出来构造一个新的索引类型：

![](https://p6-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/6a5d569cce1a4d428dd9e751b19c37c2~tplv-k3u1fbpfcp-zoom-in-crop-mark:3024:0:0:0.awebp?)
...
![](https://p9-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/3696f8a23c8e44b18b27e05aa0e23cc3~tplv-k3u1fbpfcp-zoom-in-crop-mark:3024:0:0:0.awebp?)
...
![](https://p6-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/7dff679e1cfe47198f8e2d100fe9167d~tplv-k3u1fbpfcp-zoom-in-crop-mark:3024:0:0:0.awebp?)
...
`type Copy<Obj extends Record<string, any>> = {     [Key in keyof Obj]:Obj[Key] } type PartialObjectPropByKeys<     Obj extends Record<string, any>,     Key extends keyof any = keyof Obj > = Copy<Partial<Pick<Obj,Extract<keyof Obj, Key>>> & Omit<Obj,Key>>;`

这里的 Copy 就是通过映射类型的语法构造新的索引类型，key 和 value 都不变。

这样就会计算出最终的索引类型：

![](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/1c0b497d248544d6b5b114d4847e0031~tplv-k3u1fbpfcp-zoom-in-crop-mark:3024:0:0:0.awebp?)
