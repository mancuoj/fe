...
![](https://p6-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/c4fe9c7f4a1644248c61771ea0b505a6~tplv-k3u1fbpfcp-zoom-in-crop-mark:3024:0:0:0.awebp?)
...
`type BuildArray<     Length extends number,      Ele = unknown,      Arr extends unknown[] = [] > = Arr['length'] extends Length          ? Arr          : BuildArray<Length, Ele, [...Arr, Ele]>; type Subtract<Num1 extends number, Num2 extends number> =      BuildArray<Num1> extends [...arr1: BuildArray<Num2>, ...arr2: infer Rest]         ? Rest['length']         : never;`
