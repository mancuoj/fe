...
![](https://p6-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/80819aa037ad4ad58999c084fc6381e9~tplv-k3u1fbpfcp-zoom-in-crop-mark:3024:0:0:0.awebp?)
...
![](https://p1-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/85ce35a062d14dd0920f8bd02ed6a6a3~tplv-k3u1fbpfcp-zoom-in-crop-mark:3024:0:0:0.awebp?)
...
![](https://p6-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/9e9cde7dcbc14ac3ab75299dc4006ee2~tplv-k3u1fbpfcp-zoom-in-crop-mark:3024:0:0:0.awebp?)
...
![](https://p1-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/21efe0828fd34d4697cde01a52baab87~tplv-k3u1fbpfcp-zoom-in-crop-mark:3024:0:0:0.awebp?)

当传入单个类型时：

![](https://p9-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/38909d7f1357448d92c66dae83cc4712~tplv-k3u1fbpfcp-zoom-in-crop-mark:3024:0:0:0.awebp?)
...
![](https://p6-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/3f0cbf1c3e854c6c81d0fedaa2f59623~tplv-k3u1fbpfcp-zoom-in-crop-mark:3024:0:0:0.awebp?)
...
![](https://p1-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/4c4da85cd8e04adba5f2686783cb96c4~tplv-k3u1fbpfcp-zoom-in-crop-mark:3024:0:0:0.awebp?)
...
![](https://p6-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/fbb5bc38a89546d39f148f35734bddf1~tplv-k3u1fbpfcp-zoom-in-crop-mark:3024:0:0:0.awebp?)
...
![](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/205d44d023d643c6a9ea699546b00ac2~tplv-k3u1fbpfcp-zoom-in-crop-mark:3024:0:0:0.awebp?)

![](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/b25014d24e974970920261b675e57faa~tplv-k3u1fbpfcp-zoom-in-crop-mark:3024:0:0:0.awebp?)
...
![](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/12c6d0c40cce4add8433368888184797~tplv-k3u1fbpfcp-zoom-in-crop-mark:3024:0:0:0.awebp?)

当传入数组时：

![](https://p1-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/69bf9c23dbfd403f9f90eb34c9a42545~tplv-k3u1fbpfcp-zoom-in-crop-mark:3024:0:0:0.awebp?)
...
![](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/21ec2555c40d4830a94f996ca24c5313~tplv-k3u1fbpfcp-zoom-in-crop-mark:3024:0:0:0.awebp?)
...
`type GetOptional<Obj extends  Record<string, any>> = {     [         Key in keyof Obj              as {} extends Pick<Obj, Key> ? Key : never     ] : Obj[Key]; }`
...
![](https://p6-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/43f684f0a3d744849f3f4129fceb85ba~tplv-k3u1fbpfcp-zoom-in-crop-mark:3024:0:0:0.awebp?)
...
![](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/8c0cdb56dfe343229a5f9136f52980c6~tplv-k3u1fbpfcp-zoom-in-crop-mark:3024:0:0:0.awebp?)
...
`type isRequired<Key extends keyof Obj, Obj> =      {} extends Pick<Obj, Key> ? never : Key; type GetRequired<Obj extends Record<string, any>> = {      [Key in keyof Obj as isRequired<Key, Obj>]: Obj[Key]  }`

这样就过滤出了非可选类型：

![](https://p9-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/9e89490dd2e64506b743bf99911947a2~tplv-k3u1fbpfcp-zoom-in-crop-mark:3024:0:0:0.awebp?)
...
`type Dong = {   [key: string]: any;   sleep(): void; }`
...
![](https://p9-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/c8191b63d4d8464fac18a14caa716aae~tplv-k3u1fbpfcp-zoom-in-crop-mark:3024:0:0:0.awebp?)
...
`class Dong {   public name: string;   protected age: number;   private hobbies: string[];   constructor() {     this.name = 'dong';     this.age = 20;     this.hobbies = ['sleep', 'eat'];   } }`

keyof 拿到的只有 name：

![](https://p9-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/ef7cab845ac047ac99d660c506df00e9~tplv-k3u1fbpfcp-zoom-in-crop-mark:3024:0:0:0.awebp?)
...
![](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/a8e72f143c894f6cb2c2d3a5b01e56ca~tplv-k3u1fbpfcp-zoom-in-crop-mark:3024:0:0:0.awebp?)
...
![](https://p9-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/ccdec675fc274baca8b9814f232fc4b8~tplv-k3u1fbpfcp-zoom-in-crop-mark:3024:0:0:0.awebp?)

数组：

![](https://p1-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/fcb1821d51ce4668abb6eb0414a576d8~tplv-k3u1fbpfcp-zoom-in-crop-mark:3024:0:0:0.awebp?)

但是类型编程很多时候是需要推导出字面量类型的，这时候就需要用 as const：

![](https://p9-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/d1adbd21953043aa859e3dffc9e0dae5~tplv-k3u1fbpfcp-zoom-in-crop-mark:3024:0:0:0.awebp?)

![](https://p6-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/7a15a03d6c8845279a6c87f71cc6a631~tplv-k3u1fbpfcp-zoom-in-crop-mark:3024:0:0:0.awebp?)
...
![](https://p6-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/a785c5929e3d45149fdcf35424ed5df1~tplv-k3u1fbpfcp-zoom-in-crop-mark:3024:0:0:0.awebp?)

加上 readonly 之后就可以正常匹配了：

![](https://p1-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/58e11d50a4c54327aff47b3987c38dc0~tplv-k3u1fbpfcp-zoom-in-crop-mark:3024:0:0:0.awebp?)

这点在类型编程的实际应用中经常遇到，要注意一下。 [试一下](https://www.typescriptlang.org/play?ts=4.5.0-beta#)
